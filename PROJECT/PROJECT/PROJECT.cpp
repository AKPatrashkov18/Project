...
void differenceOfSets(int numOfElements_A, int numOfElements_B, string setA[], string setB[]) {
	bool flag = true;
	cout << "A - B = ";
...
void intersectionOfSets(int numOfElements_A, int numOfElements_B, string setA[], string setB[]) {
	bool flag = true;
	bool flag1 = true;
...
void findSubsets(int numOfElements_A, int numOfElements_B, string setA[], string setB[]) {
...
void unionOfSets(int numOfElements_A,int numOfElements_B ,string setA[],string setB[]) {
...
void createSet(string setA[], string setB[]) {
	system("cls");
...
bool mainMenu(string setA[], string setB[] ) {
	
	int choice;
	cout << "Oparations with sets.\n\n";
	cout << "1 What are the sets\n";
	cout << "2 Create sets\n";
